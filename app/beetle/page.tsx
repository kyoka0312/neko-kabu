...
export default function BeetleHome() {
  return (
    <div className="max-w-md mx-auto pb-10">
      <TopBar title="カブトムシの部屋" subtitle="Beetle Room" backHref="/" accent="#3F5D3A" />
      <div className="px-5 pt-5">
        <Card>
          <MenuRow icon={Scale} label="ウェイトログ" sub="幼虫の体重を記録する" accent="#3F5D3A" href="/beetle/weight" />
          <MenuRow icon={LineChartIcon} label="系図 & 成長記録" sub="成長グラフと血統" accent="#3F5D3A" href="/beetle/overview" />
